                ...
                <form method="POST" class="col-lg-8 mx-auto fs-5 text-muted">
                    <p >
                        ...
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="student_fullname" name="student_fullname" placeholder="" value="<?= ((isset($_POST['student_fullname'])) ? sanitize($_POST['student_fullname']) : $user_data['fullname']); ?>">
                            <label for="student_fullname">Student Full name</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="student_email" name="student_email" placeholder="name@example.com" value="<?= ((isset($_POST['student_email'])) ? sanitize($_POST['student_email']) : $user_data['email']); ?>">
                            <label for="student_email">Student Email address</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="email" class="form-control" id="student_level" name="student_level" placeholder="name@example.com" value="<?= ((isset($_POST['student_level'])) ? sanitize($_POST['student_level']) : $user_data['level']); ?>">
                        ...
                        <div class="form-floating">
                            ...
                            <label for="student_password">Joined Date</label>
                        </div>
                        <div class="form-floating">
